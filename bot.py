...
class Vars:
  ...
  BOT_TOKEN = os.environ.get("BOT_TOKEN", "7689010904:AAF9iXH3annZ5BobOAZADmwttpKaEWMebzQ")
  plugins = dict(
    root="TG",
    #include=["TG.users"]
  )
  ...
  UPDATE_CHANNEL = os.environ.get("UPDATE_CHANNEL", "-1002583684553")
  ...
  FORCE_SUB_CHANNEL = os.environ.get("FORCE_SUB_CHANNEL", "𝕵𝖔𝖎𝖓 𝕮𝖍𝖆𝖓𝖓𝖊𝖑: AnimeNexusNetwotk, 𝕸𝖆𝖎𝖓 𝕮𝖍𝖆𝖓𝖓𝖊𝖑: MangaNexus")
...
Sleep mode deactivated. Neural cores at 100%. Feed me tasks, and watch magic happen. Let’s. Get. Dangerous.</b></blockquote>"""
    ...
    button = [[
      ...
      InlineKeyboardButton("*Channel*", url = "telegram.me/AnimeNexuNetwork")
    ]]
